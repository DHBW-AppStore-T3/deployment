...
# instead of running as an overlay on appstore-prod-01. Must be re-verified
# against `openstack server list` after every rebuild of
# hermes-dhbw-appstore; the address is not guaranteed stable across a VM
# replacement.
